...
export default function ProductBuyBox({ product }) {
  ...
  return (
    <div className="buy-box">
      ...
      <a className="whatsapp-order" href={`https://wa.me/923000000000?text=${encodeURIComponent(`Assalamualaikum, I want ${qty} x ${product.name} (${product.packSize}).`)}`} target="_blank" rel="noreferrer">Order / Ask on WhatsApp</a>
    </div>
  );
}
